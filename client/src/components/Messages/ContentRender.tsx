...
import type { TMessage, TMessageContentParts, TRecipe } from 'librechat-data-provider';
...
const ContentRender = memo(
  ({
    ...
    /** Show "Écrire la recette" button for assistant messages from agents endpoint */
